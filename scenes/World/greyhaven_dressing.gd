...
func _add_ground_layers() -> void:
	var normal_detail := [
		[Vector2(180,300),0.62,-0.08],[Vector2(410,405),0.78,0.05],[Vector2(650,310),0.58,-0.03],
		[Vector2(230,700),0.70,0.06],[Vector2(505,825),0.82,-0.05],[Vector2(720,1080),0.62,0.08],
...
func _add_composed_edges() -> void:
	...
	for data in [
		...
		[Vector2(1320,520),0.54,0.02,Color(0.61,0.62,0.54,0.78)],
		[Vector2(1505,1060),0.50,-0.03,Color(0.48,0.47,0.43,0.72)]
	]:
		var wall := _sprite(MOSSY_WALL, data[0], data[1], data[3], data[2])
		wall.z_index = 1

	for data in [
		[Vector2(450,570),0.50,-0.05,Color(0.86,0.87,0.70,0.90)],
		[Vector2(650,630),0.42,0.04,Color(0.78,0.80,0.64,0.84)],
		[Vector2(430,1080),0.56,0.03,Color(0.84,0.84,0.68,0.88)],
		[Vector2(1250,500),0.42,-0.02,Color(0.72,0.73,0.60,0.80)],
		[Vector2(1370,980),0.46,0.05,Color(0.60,0.57,0.54,0.72)]
	]:
	...
	for data in [
		...
		[Vector2(1450,430),0.82,0.03,Color(0.56,0.59,0.53,0.82)],
		[Vector2(1580,500),0.68,-0.02,Color(0.47,0.48,0.46,0.76)]
	]:
